...
from customers.controllers.customerController import add_customer, get_by_id, get_all, get_orders

customer_routes = Blueprint('customer_routes', __name__)

customer_routes.route('/api/v1/customers', methods=['POST'])(add_customer)
customer_routes.route('/api/v1/customers/id/<int:id>', methods=['GET'])(get_by_id)
